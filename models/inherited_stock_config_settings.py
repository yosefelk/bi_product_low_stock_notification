				...
				if company:
					for company_is in company:
						...
						if template_id:
							...
							values['res_id'] = False
							pdf = self.env.ref('bi_product_low_stock_notification.action_low_stock_report').render_qweb_pdf()[0]
							values['attachment_ids'] = [(0,0,{
								'name': 'Product Low Stock Report'+ '.pdf',
